...
import { SERIES_MATH_OPS, WINDOW_OPS, COMPOSITE_OPS } from '@/domain/constants/expression-types';
...
describe('MetricDependencyExtractorService', () => {
  describe('extractSeriesCodes', () => {
    it('should extract series codes from simple series_math expression', () => {
      ...
      const result = MetricDependencyExtractorService.extractSeriesCodes(metric);
